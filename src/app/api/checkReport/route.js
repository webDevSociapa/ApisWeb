...
// MongoDB Connection
// mongoose.connect("mongodb+srv://webdev:2OmPVj8DUdEaU1wR@apisindia.38dfp.mongodb.net/ProductReport", {
...
//       pdf.Image("@/assets/images/OurBrands/checkreport.jpeg", 0, 0, 210, 297); // A4 size in mm (210 x 297)

//       // Add dynamic batch no. text
//       pdf.SetFont("Arial", "B", 16);
//       pdf.SetTextColor(0, 0, 0); // Black color
//       pdf.Text(50, 150, `Batch: ${batchData.batchNo}`); // x, y position where you want to place batch no.
