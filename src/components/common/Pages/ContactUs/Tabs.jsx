...
const Tabs = () => {
  ...
  return (
    <div className="w-full text-center py-8 px-4">
      ...
      <div>
        <h1 className="text-[#545454] text-3xl font-bold mb-10 pt-10 capitalize">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
          <img
            ...
            className="w-full md:w-96 h-auto object-cover border border-stone-500"
          />
          <div className="w-full md:w-1/2 mt-4 md:mt-0">
            <div className="mb-6">
              <h3 className="text-[#9F7B49] text-xl font-bold mb-2">Address</h3>
            ...
            <div>
              <h3 className="text-[#9F7B49] text-xl font-bold mb-2">
                Registered office
              </h3>
              <p className="text-black text-sm leading-relaxed">
                {tabContent[activeTab].address1}
